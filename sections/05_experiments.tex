...
\begin{table}[t]
  ...
  \begin{tabular}{lccc}
  \toprule
  \rowcolor{lightgray}  & 1 Mode & 2 Modes & 4 Modes \\
  \midrule
...
\midrule
\rowcolor{lightgray!50}\texttt{RES} & 0.96 & 0.97 & $4.00 / 4$ & 0.99 \\
\texttt{DSRL} & 1.00 & 0.25 & $1.00 / 4$ & 0.00 \\
\rowcolor{lightgray!50}\texttt{DPPO[10]} & 1.00 & 0.25 & $1.00 / 4$ & 0.00 \\
