...
\midrule
\rowcolor{lightgray!50}\texttt{PRE} & $0.32 $ & $0.31  $ & $0.00 / 4$& $0.99 $  \\
\midrule
\texttt{DSRL} & $1.00 $ & $0.25  $ & $1.00 / 4$& $0.00  $ \\
\rowcolor{lightgray!50}\texttt{DSRL[\methodname{}]} & $0.96 $ & $0.96  $ & $4.00 / 4$& $0.99 $  \\
\bottomrule
\end{tabular}%
}
\end{minipage}\hfill
...
\textbf{Method} & $\mathrm{SR}$ $(\uparrow)$& $\mathrm{SR}_{\mathrm{M}}$ $(\uparrow)$ & $\mathrm{mc}@0.80$ $(\uparrow)$& $\mathcal{H}$ $(\uparrow)$ \\
\midrule
\rowcolor{lightgray!50}\texttt{PRE} & $0.05 $ & $0.06  $ & $0.00 / 4$& $0.90 $  \\
\midrule
\texttt{DSRL} & $0.98 $ & $0.24  $ & $1.00 / 4$& $0.00  $ \\
\rowcolor{lightgray!50}\texttt{DSRL[\methodname{}]} & $0.69 $ & $0.69  $ & $2.00 / 4$& $0.99 $  \\
\bottomrule
\end{tabular}%
}
\end{minipage}
