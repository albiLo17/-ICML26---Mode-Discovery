...
A common limitation of the aforementioned approaches is that they lack explicit mechanisms to preserve multimodality, and often converge to a single reward-maximizing solution. Our work extends the steering-policy framework by introducing mode discovery to discover and control latent modalities while biasing all behaviors towards higher rewards.
