...
A common limitation of the aforementioned approaches is that they lack explicit mechanisms to preserve multimodality, and often converge to a single reward-maximizing behavior. Our work extends the steering-policy framework by discovering and controlling latent modalities of nosise-conditioned generative policies, allowing to regularize \ac{rlft} to preserve multimodality while adapting to the downstream task.
